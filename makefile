...
EXAMPLESOBJS=hsserver.o hsclient.o eth.o pant.o selec.o red.o concent.o database.o datos.o driver.o queue.o main.o generat.o cpu.o transduc.o trafico.o distri.o com.o linpack.o debug.o register.o
LIBNAME=simu
LIBS=-lsimu
...
simu: ${ALLOBJS}  libsimu.a
	${CPP} ${LDFLAGS} -o $@ ${EXAMPLESOBJS} ${LIBS}
